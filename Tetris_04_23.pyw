...
#Susikuriam FPS kintamaji
FPS = 5

#Sukuriam ekrano parametrus
EKRANO_DYDIS = [400,600]

#Sukuriam pilka spalva
PILKA = (200,200,200)

#Sukuriam balta spalva
BALTA = (255,255,255)

#Tetrio zemelapio dydzio kintamieji
DYDIS_X = 12
DYDIS_Y = 20
...
#Laukimo laiko kintamasis
LAUKIMO_LAIKAS = 0

#Susikuriam "figuros_pasirinkimo" kintamuosius
TIPU_PASIRINKIMAI = (1,4)
...
class Zaidimas(object):
        ...
        for ivykis in pygame.event.get():
            ...
            # 8.0 Susikuriame metoda "judintiFigura" nuo kurio priklausys musu figuros judejimas
                ...
                if ivykis.key == pygame.K_RIGHT:
                    ...
                    # 9. Susikuriam metoda "pasuktiFigura" kuris pasuktu musu figura i tam tikra puse
                    self.pasuktiFigura()
    ...
    def sukurtiDabartineFigura(self):
        ...
        dabartinis_tipas = random.randint(TIPU_PASIRINKIMAI[0],TIPU_PASIRINKIMAI[1])
        ...
        # 5.3 Galiausiai ciklu pereisime per sukurtos figuros kiekvieno kvadratelio x ir y
	...
	# Darome "rodytiZaidimoLauka() funkcija"
        self.rodytiZaidimoLauka()
        return True


# 55. Sukuriame funkcija "valytiGrindis"
    def valytiGrindis(self):
        arLinijaPilna = False
    ...
    def leisti(self):
	    ...
	    # jeigu ne figura tai darome funkcija "valytiGrindis"
            if not self.figura:
                self.valytiGrindis()
